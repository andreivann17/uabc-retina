...
ONNX_PATH = os.path.join(MODEL_DIR, "model_diabetic_retinopathy_stages.onnx")

STAGES = [
    {"id_stages": 1, "name": "Mild"},
    {"id_stages": 2, "name": "Moderate"},
    {"id_stages": 3, "name": "Severe"},
    {"id_stages": 4, "name": "Proliferative"},
]
...
def init_models_local():
    ...
    model_map = {
        ...
        "id2label": {0: "Mild", 1: "Moderate", 2: "Severe", 3: "Proliferative"},
        "num_labels": 4,
    }
...
def predict_image(image_path, filename=None):
    ...
    stages_list = model_map["stages"]
    id_stages = stages_list[predicted_class_idx]["id_stages"]
